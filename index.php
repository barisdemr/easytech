...
<body>
    ...
    <header class='Header'>
     ...
     <div class='anaEkran' >
        <div class="intro" id="slideshow">
        <img src="assets/image/intro2.jpg" name="intro">
        <img src="assets/image/intro1.jpg" name="intro">
        </div>
        ...
        <div class="resims">
          <div class="sol">
            <img src="assets/image/turuncusaat.jpg" alt="" id="deneme">
            <img src="assets/image/siyahsaat.jpg" alt="" >
          </div>
          <div class="sag">
            <img src="assets/image/3tel.jpg" alt="">
          </div>
        </div>
